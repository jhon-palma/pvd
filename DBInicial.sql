...
--
-- Servidor: localhost
-- Tiempo de generación: 16-04-2018 a las 20:21:58
...
--
-- Estructura de tabla para la tabla `asistencia_tipo`
--
...
--
-- Volcado de datos para la tabla `asistencia_tipo`
--
...
(1, 'pbkdf2_sha256$100000$fgNlm0H0LajK$czQ+2Ppd8FhuGqh1ER7SXbTMHHsFqG70ws8YhEn+alE=', '2018-04-16 19:13:34', 0, '1070593028', 'JHON JAIRO', 'PALMA GARCIA', 'jhon1946@gmail.com', 0, 1, '2018-03-22 20:30:00', 1),
(2, 'pbkdf2_sha256$100000$fgNlm0H0LajK$czQ+2Ppd8FhuGqh1ER7SXbTMHHsFqG70ws8YhEn+alE=', '2018-04-16 16:49:36', 0, '11111111', 'JOSE MAURICIO', 'VELASQUEZ TRUJILLO', 'sistemas@mail.com', 0, 1, '2018-04-16 15:36:48', 1);
...
ALTER TABLE `asistencia_curso`
 ADD PRIMARY KEY (`id`), ADD KEY `asistencia_curso_entidad_id_ec2e8301_fk_asistencia_entidad_id` (`entidad_id`), ADD KEY `asistencia_curso_sede_id_1af3461c_fk_asistencia_sede_id` (`sede_id`), ADD KEY `asistencia_curso_tipo_id_058f4098_fk_asistencia_tipo_id` (`tipo_id`);
...
--
-- Indices de la tabla `asistencia_tipo`
--
...
--
-- AUTO_INCREMENT de la tabla `asistencia_tipo`
--
ALTER TABLE `asistencia_tipo`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
